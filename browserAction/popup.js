...
altPSTAT.addEventListener('click', function() {
  browser.runtime.sendMessage({"key": "getAlternatePSTAT"});
});
...
browser.storage.sync.get(['shortcutText1','shortcutLink1','shortcutText2','shortcutLink2','shortcutText3','shortcutLink3',
  ...
  if (res.shortcutLink1) {
    if (res.shortcutLink1.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink1': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink2) {
    if (res.shortcutLink2.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink2': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink3) {
    if (res.shortcutLink3.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink3': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink4) {
    if (res.shortcutLink4.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink4': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink5) {
    if (res.shortcutLink5.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink5': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink6) {
    if (res.shortcutLink6.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink6': res.shortcutLink1});
    }
  ...
  if (res.shortcutLink7) {
    if (res.shortcutLink7.includes('kohalibrary.com')) {
      ...
      browser.storage.sync.set({'shortcutLink7': res.shortcutLink1});
    }
